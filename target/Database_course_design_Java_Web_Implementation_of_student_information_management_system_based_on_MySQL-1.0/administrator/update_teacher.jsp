...
<div class="form">
    <br/>
    <form action="update_teacher_result.jsp" method="post">
        <table border="1" class="animated bounceInDown">
            ...
            <tr>
                ...
                <td>
                    <label>
                        <input class="c" type="text" name="teacher_name" value="<%=teacher.getTeacher_name()%>">
                    </label>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <label>
                        <input class="c" type="text" name="teacher_sex" value="<%=teacher.getTeacher_sex()%>"/>
                    </label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <label>
                        <input class="c" type="email" name="teacher_email" value="<%=teacher.getTeacher_email()%>"/>
                    </label>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <label>
                        <input class="c" type="text" name="teacher_address" value="<%=teacher.getTeacher_address()%>"/>
                    </label>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <label>
                        <input class="c" type="text" name="teacher_idcard" value="<%=teacher.getTeacher_idcard()%>"/>
                    </label>
                </td>
            </tr>
