...
<%@ page import="java.util.List" %><%--
  ...
  File name(文件名): forum_management
  Author(作者）: mao
...
<table class="animated fadeInUp">
    ...
    <tr>
        ...
        <td>
            <%
                //获取内容
                String text = forum.getForum_content();
                //不能太长
                if (text.length() > 70)
                {
        ...
        <td>
            <a style="width: 50px;display:inline;"
               href="delete_forum_result.jsp?forum_no=<%=forum.getForum_no()%>">删除</a>
        </td>
    </tr>
    <%
        }
...
%>
<div class="before">
    <a class="animated slideInLeft" href="forum_management.jsp?page=<%=(curr_page-1)%>">上一页</a>
</div>
<%
    }
%>
...
%>
<div class="before2">
    <a class="animated slideInLeft" href="forum_management.jsp?page=<%=(curr_page-2)%>">前两页</a>
</div>
<%
    }
%>
...
%>
<div class="next">
    <a class="animated slideInRight" href="forum_management.jsp?page=<%=(curr_page+1)%>">下一页</a>
</div>
<%
    }
%>
...
%>
<div class="next2">
    <a class="animated slideInRight" href="forum_management.jsp?page=<%=(curr_page+2)%>">后两页</a>
</div>
<%
    }
%>
...
%>
<div class="first">
    <a class="animated rotateInUpLeft" href="forum_management.jsp?page=<%=(1)%>">第一页</a>
</div>
<%
    }
%>
...
%>
<div class="last">
    <a class="animated rotateInUpRight" href="forum_management.jsp?page=<%=(pageCount)%>">最后一页</a>
</div>
<%
    }
%>
