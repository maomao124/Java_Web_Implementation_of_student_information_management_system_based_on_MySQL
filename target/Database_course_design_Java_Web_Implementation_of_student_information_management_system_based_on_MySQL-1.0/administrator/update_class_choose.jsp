...
<%@ page import="java.util.List" %><%--
  ...
  File name(文件名): update_class_choose
  Author(作者）: mao
...
<table class="animated fadeInUp">
    ...
    <tr>
        ...
        <td>
            <a href="update_a_class.jsp?class_no=<%=c.getClass_no()%>">更新</a>
        </td>
        <td>
            <a href="delete_a_class.jsp?class_no=<%=c.getClass_no()%>">删除</a>
        </td>
    </tr>
    <%
        }
