...
<%@ page import="java.util.List" %><%--
  ...
  File name(文件名): update_course_courseList
  Author(作者）: mao
...
<table class="animated fadeInUp">
    ...
    <tr>
        ...
        <td>
            <a href="update_course.jsp?course_no=<%=course.getCourse_no()%>">更新</a>
        </td>
        <td>
            <a href="delete_course.jsp?course_no=<%=course.getCourse_no()%>">删除</a>
        </td>
    </tr>
    <%
        }
