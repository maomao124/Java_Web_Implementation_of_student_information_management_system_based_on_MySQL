...
<div class="text_p">
    <div class="text animated flipInY">
        更新课程编号为
        <%=courseInformation.getCourse_no()%>、
        课程名称为
        <%=courseInformation.getCourse_name()%>
        的信息
    </div>
</div>
<div class="form">
    ...
    <form action="update_course_result.jsp" method="post">
        <table border="1" class="animated bounceInDown">
            ...
            <tr>
                ...
                <td>
                    <label>
                        <input class="c" type="text" name="course_name" value="<%=courseInformation.getCourse_name()%>">
                    </label>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <label>
                        <input class="c" type="number" min="0.0" max="100.0" step="0.1" name="course_credit"
            ...
            <tr>
                ...
                <td>
                    <label>
                        <input class="c" type="number" min="0.0" max="100.0" step="1" name="course_hour"
