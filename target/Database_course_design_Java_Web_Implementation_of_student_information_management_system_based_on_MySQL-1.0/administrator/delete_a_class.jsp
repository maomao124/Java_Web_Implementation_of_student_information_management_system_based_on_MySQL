...
<div class="text_p">
    <div class="text animated flipInY">
        删除班级信息
        <br/>
        删除班级之前要确保已经删除掉与此信息关联的信息，否则将删除失败
    </div>
</div>
<div class="form">
    <br/>
    <form action="delete_a_class_result.jsp" method="post">
        <table border="1" class="animated bounceInDown">
            ...
            <tr>
                ...
                <td>
                    <label>
                        <input class="c" type="text" name="class_name" readonly="readonly"
                               value="<%=classInformation.getClass_name()%>">
                    </label>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <label>
                        <input class="c" type="text" name="class_college" readonly="readonly"
            ...
            <tr>
                ...
                <td>
                    <label>
                        <input class="c" type="text" name="class_major" readonly="readonly"
                               value="<%=classInformation.getClass_major()%>"/>
                    </label>
                </td>
            </tr>
            <tr>
