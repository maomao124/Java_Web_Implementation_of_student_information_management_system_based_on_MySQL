...
<div class="form">
    <br/>
    <form action="insert_a_class_result.jsp" method="post">
        <table border="1" class="animated bounceInDown">
            ...
            <tr>
                ...
                <td>
                    <label>
                        <input class="c" type="text" name="class_name">
                    </label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <label>
                        <input class="c" type="text" name="class_major"/>
                    </label>
                </td>
            </tr>
            <tr>
